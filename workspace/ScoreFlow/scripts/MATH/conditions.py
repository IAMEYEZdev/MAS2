...
START_PORMPT = '''You objective is to output a workflow graph WITH llm placeholders, based on the following template:
...
class Workflow:
    def __init__(
        ...
        self.gid = None
        self.custom = operator.Custom("llm_symbol", self.gid, self.problem)
        ...
        self.review = operator.Review("llm_symbol", self.gid, self.problem)
